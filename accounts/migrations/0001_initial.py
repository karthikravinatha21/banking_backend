...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.DecimalField(
                        decimal_places=2, default=Decimal("5000.00"), max_digits=15
                    ),
                ),
                (
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        ...
                        name="accounts_lo_email_351ee0_idx",
                    ),
                    models.Index(
        ...
        migrations.AddIndex(
            model_name="account",
            index=models.Index(
                fields=["account_number"], name="accounts_ac_account_ddc8cc_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="account",
            index=models.Index(
                fields=["user", "status"], name="accounts_ac_user_id_7fbf1c_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="account",
            index=models.Index(
                fields=["currency"], name="accounts_ac_currenc_6309d1_idx"
            ),
        ),
    ]
